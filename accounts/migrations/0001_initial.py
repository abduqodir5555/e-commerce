    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('register', 'Register'), ('reset_password', 'Reset password')], max_length=30, verbose_name='Verification Type')),
                ('expires_in', models.DateTimeField(verbose_name='Expires time')),
